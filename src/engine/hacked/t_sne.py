...
# Modified to allow extracting intermediary slices by Gilles Waeber, VII 2019
# Original location: sklearn.manifold.t_sne
...
def _gradient_descent(objective, p0, it, n_iter,
    ...
    for i in range(it, n_iter):
        ...
        if save_slices_to is not None:
            save_slices_to.append(p.copy())
        p += update
...
class TSNE(BaseEstimator):
    ...
    def _fit(self, X, skip_num_points=0, save_slices_to=None):
        ...
        return self._tsne(P, degrees_of_freedom, n_samples,
                          ...
                          save_slices_to=save_slices_to)

    def _tsne(self, P, degrees_of_freedom, n_samples, X_embedded,
              neighbors=None, skip_num_points=0, save_slices_to=None):
        """Runs t-SNE."""
    ...
    def fit_transform(self, X, y=None, save_slices_to=None):
        ...
        X_new : array, shape (n_samples, n_components)
            Embedding of the training data in low-dimensional space.
        """
        embedding = self._fit(X, save_slices_to=save_slices_to)
